  ...
  updateCustomer() {
    this.customerService.updateCustomer(this.showCustomer)
                      .subscribe((message: Message) => {
                        ...
                        let msg: string = "Actualizacion Exitosa!<br>"
                                          + "<ul>"
                                            + "<li>" + "id: " + this.showCustomer.id + "</li>"
                                            + "<li>" + "Nombre: " + this.showCustomer.firstname + "</li>"
                                            + "<li>" +  "Destino: " + this.showCustomer.lastname + "</li>"
                                          
                                            + "<li>" +  "Fecha: " + this.showCustomer.address + "</li>"
                                          + "</ul>";
